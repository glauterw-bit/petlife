...
export default function PetProfilePage() {
  ...
  return (
    <DashboardLayout>
        ...
        {tabs.map(t => (
          <button
            ...
            className={cn(
              ...
              tab === t.id ? 'bg-primary-500 text-white' : 'text-surface-600 dark:text-surface-300 hover:bg-surface-50 dark:hover:bg-surface-700/40'
            )}
          >
            {t.icon}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700 p-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-surface-600 dark:text-surface-300">Total de exames</span>
                  <span className="font-semibold text-surface-900 dark:text-white">{exams.length}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-surface-600 dark:text-surface-300">Anamneses</span>
                  <span className="font-semibold text-surface-900 dark:text-white">{anamnesisHistory.length}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-surface-600 dark:text-surface-300">Rotinas</span>
                ...
                {pet.microchip && (
                  <div className="flex justify-between items-center text-sm border-t border-surface-100 dark:border-surface-700 pt-3">
                    <span className="text-surface-600 dark:text-surface-300">Microchip</span>
            ...
            <div className="bg-gradient-to-br from-primary-50 via-white to-emerald-50 rounded-2xl border border-primary-200 p-5">
              <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="font-bold text-surface-900 dark:text-white">Plano de saúde sugerido</h3>
      ...
      {tab === 'health' && (
        <div className="space-y-6 animate-fade-in">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-surface-900 dark:text-white">Vacinas</h2>
          ...
          <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-surface-900 dark:text-white">Exames</h2>
      ...
      {tab === 'routine' && (
        <div className="animate-fade-in">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-surface-900 dark:text-white">Rotinas de Passeio</h2>
            <button
          ...
          {routines.length === 0 ? (
            <div className="text-center py-16 bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700">
              ...
              <h3 className="font-semibold text-surface-900 dark:text-white mb-1">Nenhuma rotina criada</h3>
              <p className="text-surface-500 dark:text-surface-400 text-sm mb-4">Clique em "Gerar Rotina com IA" para criar uma rotina personalizada</p>
            </div>
          ) : (
            routines.map(r => (
              <div key={r.id} className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700 p-6">
                ...
                <div className="mb-4">
                  <p className="text-sm font-medium text-surface-700 dark:text-surface-200 mb-2">Horários sugeridos:</p>
                ...
                {r.exercise_type && (
                  <div className="mb-4 text-sm">
                    <span className="font-medium text-surface-700 dark:text-surface-200">Tipo de exercício:</span>{' '}
                    <span className="text-surface-600 dark:text-surface-300">{r.exercise_type}</span>
                  </div>
                )}
                {r.tips && r.tips.length > 0 && (
                  <div>
                    <p className="text-sm font-medium text-surface-700 dark:text-surface-200 mb-2">Dicas:</p>
      ...
      {tab === 'history' && (
        <div className="animate-fade-in">
          <h2 className="text-xl font-bold text-surface-900 dark:text-white mb-6">Histórico de Anamneses</h2>
          {anamnesisHistory.length === 0 ? (
            <div className="text-center py-16 bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700">
              <div className="text-5xl mb-3">📋</div>
              <p className="text-surface-500 dark:text-surface-400">Nenhuma anamnese registrada ainda.</p>
            </div>
          ) : (
              ...
              {anamnesisHistory.map(a => {
                ...
                return (
                  <div key={a.id} className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700 p-5">
                    ...
                    <div className="text-sm text-surface-800 dark:text-surface-100 font-medium mb-2">Sintomas:</div>
      ...
      {tab === 'anamnesis' && (
        <div className="animate-fade-in">
          <h2 className="text-xl font-bold text-surface-900 dark:text-white mb-2">Nova Anamnese</h2>
          <p className="text-surface-500 dark:text-surface-400 text-sm mb-6">Descreva os sintomas e nossa IA irá analisar e recomendar os próximos passos.</p>
          ...
          <form onSubmit={handleAnamSubmit} className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700 p-6 space-y-4">
            <div>
              <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Sintomas observados *</label>
              <textarea
                required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Há quanto tempo?</label>
                <input type="text" value={anamForm.duration} onChange={e => setAnamForm(f => ({ ...f, duration: e.target.value }))} placeholder="Ex: 2 dias, 1 semana..." className="w-full px-4 py-3 border border-surface-200 dark:border-surface-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Apetite</label>
              ...
              <div>
                <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Ingestão de água</label>
              ...
              <div>
                <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Mudanças de comportamento</label>
                <input type="text" value={anamForm.behavior_changes} onChange={e => setAnamForm(f => ({ ...f, behavior_changes: e.target.value }))} placeholder="Ex: Mais quieto, agressivo..." className="w-full px-4 py-3 border border-surface-200 dark:border-surface-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Medicamentos em uso</label>
                <input type="text" value={anamForm.medications} onChange={e => setAnamForm(f => ({ ...f, medications: e.target.value }))} placeholder="Ex: Nenhum / nome do remédio" className="w-full px-4 py-3 border border-surface-200 dark:border-surface-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-surface-700 dark:text-surface-200 mb-1.5">Observações adicionais</label>
              <textarea value={anamForm.notes} onChange={e => setAnamForm(f => ({ ...f, notes: e.target.value }))} rows={2} placeholder="Qualquer informação relevante..." className="w-full px-4 py-3 border border-surface-200 dark:border-surface-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none" />
            </div>
            <button
              type="submit"
      ...
      {tab === 'stories' && (
        <div className="animate-fade-in">
          <div className="mb-6">
            ...
            <p className="text-surface-500 dark:text-surface-400 text-sm mt-0.5">Timeline de fotos com legendas geradas por IA.</p>
          </div>
      ...
      {tab === 'family' && (
        <div className="animate-fade-in">
          <div className="mb-6">
            ...
            <p className="text-surface-500 dark:text-surface-400 text-sm mt-0.5">Conecte irmãos, pais, filhotes ou amigos. Outros tutores precisam confirmar.</p>
          </div>
      ...
      {tab === 'care' && (
        <div className="animate-fade-in">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-surface-900 dark:text-white">Guia de Cuidados IA</h2>
              <p className="text-surface-500 dark:text-surface-400 text-sm mt-0.5">Cuidados personalizados para a raça e idade de {pet.name}</p>
            </div>
          ...
          {!pet.breed_id && (
            <div className="text-center py-16 bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700">
              <div className="text-5xl mb-3">🧬</div>
              <p className="text-surface-700 dark:text-surface-200 font-medium">Raça não informada</p>
              <p className="text-surface-500 dark:text-surface-400 text-sm mt-1">Cadastre a raça do seu pet para receber um guia de cuidados personalizado.</p>
            </div>
          )}
          {pet.breed_id && !careGuide && !generatingCare && (
            <div className="text-center py-16 bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700">
              <div className="text-5xl mb-3">✨</div>
              <p className="text-surface-700 dark:text-surface-200 font-medium mb-2">Guia de cuidados não gerado ainda</p>
              <p className="text-surface-500 dark:text-surface-400 text-sm">Clique em "Gerar Guia IA" para receber dicas personalizadas.</p>
            </div>
          )}
          {careGuide && (
            <div className="space-y-4">
