...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-white/95 backdrop-blur border-t border-surface-200 dark:border-surface-700 pb-[env(safe-area-inset-bottom)]"
    >
